...
namespace TestOMatic2012
{
    ...
    partial void InsertFourCount(FourCount instance);
    partial void UpdateFourCount(FourCount instance);
    partial void DeleteFourCount(FourCount instance);
    #endregion
		...
		public System.Data.Linq.Table<FourCount> FourCounts
		{
			get
			{
				return this.GetTable<FourCount>();
			}
		}
	}
	...
	public partial class MixDestPollItem : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private System.Nullable<int> _DaypartId;
    ...
    partial void OnDaypartIdChanging(System.Nullable<int> value);
    partial void OnDaypartIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_DaypartId", DbType="Int")]
	...
	[global::System.Data.Linq.Mapping.TableAttribute(Name="dbo.FourCount")]
	public partial class FourCount : INotifyPropertyChanging, INotifyPropertyChanged
	{
		
		private static PropertyChangingEventArgs emptyChangingEventArgs = new PropertyChangingEventArgs(String.Empty);
		
		private int _FourCountId;
		
		private string _Unit;
		
		private System.DateTime _FileDate;
		
		private int _FourCount1;
		
    #region Extensibility Method Definitions
    partial void OnLoaded();
    partial void OnValidate(System.Data.Linq.ChangeAction action);
    partial void OnCreated();
    partial void OnFourCountIdChanging(int value);
    partial void OnFourCountIdChanged();
    partial void OnUnitChanging(string value);
    partial void OnUnitChanged();
    partial void OnFileDateChanging(System.DateTime value);
    partial void OnFileDateChanged();
    partial void OnFourCount1Changing(int value);
    partial void OnFourCount1Changed();
    #endregion
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FourCountId", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int FourCountId
		{
			get
			{
				return this._FourCountId;
			}
			set
			{
				if ((this._FourCountId != value))
				{
					this.OnFourCountIdChanging(value);
					this.SendPropertyChanging();
					this._FourCountId = value;
					this.SendPropertyChanged("FourCountId");
					this.OnFourCountIdChanged();
				}
			}
		}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Name="FourCount", Storage="_FourCount1", DbType="Int NOT NULL")]
		public int FourCount1
		{
			get
			{
				return this._FourCount1;
			}
			set
			{
				if ((this._FourCount1 != value))
				{
					this.OnFourCount1Changing(value);
					this.SendPropertyChanging();
					this._FourCount1 = value;
					this.SendPropertyChanged("FourCount1");
					this.OnFourCount1Changed();
				}
			}
		}
